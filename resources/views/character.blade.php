                        ...
                        <tr>
                            ...
                            <td>
                                @foreach($groupedByTier[$tier] as $item)
                                    ...
                                    <div class="tier-icon-caption">
                                        <span class="tier-icon-name">{{ $item->character_name }}</span>
                                        @if($item->weapon_type !== 'All')<span class="tier-icon-weapon">{{ $item->weapon_type }}</span>@endif
                                    </div>
                                    </div>
                                @endforeach
                            </td>
