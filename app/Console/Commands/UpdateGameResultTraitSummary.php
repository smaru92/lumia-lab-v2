...
class UpdateGameResultTraitSummary extends Command
{
     ...
     * @var string
     */
    protected $signature = 'update:game-results-trait-summary {version_season?} {version_major?} {version_minor?} {version_hotfix?}';
    ...
    public function handle(GameResultTraitSummaryService $gameResultSummaryService)
    {
        ...
        $gameResultSummaryService->updateGameResultTraitSummary($versionSeason, $versionMajor, $versionMinor, $versionHotfix);
    }
}
