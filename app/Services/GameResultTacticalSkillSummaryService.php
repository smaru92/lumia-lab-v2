...
class GameResultTacticalSkillSummaryService
{
     ...
     * @return void
     */
    public function updateGameResultTacticalSkillSummary($versionSeason = null, $versionMajor = null, $versionMinor = null, $versionHotfix = null)
    {
    ...
    public function getDetail(array $filters)
    {
        ...
        foreach ($result as $skillId => $levelData) {
            ...
            if ($firstItem && $gameCount > 0) {
                $aggregatedBySkill[] = [
                    'tactical_skill_id' => $skillId,
                    'tactical_skill_name' => $firstItem->tactical_skill_name,
                    'tactical_skill_tooltip' => $firstItem->tactical_skill_tooltip ?? '',
                    'game_count' => $gameCount,
                    'top1_count' => $top1Count,
                    'top2_count' => $top2Count,
                    'top4_count' => $top4Count,
        ...
        // 사용수 기준 내림차순 정렬
        usort($aggregatedBySkill, function($a, $b) {
        ...
        return [
            ...
            'aggregatedBySkill' => $aggregatedBySkill
        ];
    }
