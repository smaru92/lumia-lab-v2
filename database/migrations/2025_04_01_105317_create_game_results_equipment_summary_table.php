...
return new class extends Migration
{
    ...
    {
        Schema::create('game_results_equipment_summary', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['character_id', 'weapon_type', 'equipment_id', 'min_tier', 'version_major', 'version_minor', 'game_rank'], 'game_result_rank_summary_unique');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('game_results_equipment_summary');
    }
};
